...
var Chart = function (_React$Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function componentDidUpdate(lastProps, lastState) {
      if (!lastProps.complete && this.props.complete) {
    ...
    value: function render() {
      ...
      elems = data.map(function (d, i) {
        ...
        var dX = xScale(d[_this3.props.xData]);
        if (isNaN(dX)) return;
        ...
        if (showTicks) {
          ticks.push(_react2.default.createElement('line', {
            ...
            strokeWidth: '2',
            stroke: '#ddd',
            x1: xScale(d[_this3.props.xData]),
            x2: xScale(d[_this3.props.xData]),
            y1: scaleHalf,
      ...
      var goalOffSet = this.getOffset(labelPos, data.length);
      ...
      dots.push(_react2.default.createElement(_Dot2.default, {
        ...
        r: '6',
        style: _extends({}, complete ? goalCompleteDotStyle : goalDotStyle),
        y: scaleHalf }));
